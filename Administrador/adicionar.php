                ...
                <div class="container-fluid mt-5">
                    <nav class="mt-2" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Adicionar Imagem</li>
                        </ol>
                    </nav>
                    <!-- Page Heading -->
                    <h1 class="h3 mb-4 text-gray-800 mt-2">Adicionar nova Imagem na galeria</h1>
                        ...
                        <div class="card-body">
                            <?php
                                if (isset($_GET['id']) && !empty($_GET['id'])) {
                                    ...
                                    if ($p->adicionarNovaImagemGaleria($id, $galeria) == true) {
                            ?>
                            ...
                            <div class="form-group row">
                                    ...
                                    <label><b>Imagem Produto</b></label>
                                ...
                                <div class="text-center">
                                    <div class="form-group row mt-5 mb-5">
                                        ...
                                        <button type="submit" class="btn btn-warning btn-user btn-block">Nova Imagem</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
